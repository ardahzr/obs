...
Frontend otomatik olarak 5174'e geçecektir.

### Django migrations hatası
```bash
cd po_manager
source ../venv/bin/activate
python manage.py migrate
...
### CORS hatası
`settings.py` içinde `CORS_ALLOW_ALL_ORIGINS = True` olduğundan emin olun.

## 📝 Lisans

Bu proje Acıbadem CSE için geliştirilmiştir.

## 👨‍💻 Geliştirici

Acıbadem University - CSE Department
